---
title: "개인정보 처리방침"
description: "2022년 10월 15일 부터 적용"
---
...
> 이 개인정보처리방침은 2022년 10월 15부터 적용됩니다.		
...
| --- | --- | --- | --- | --- |
| 행사 참가자 등록과 등록비 결제 및 참가자 확인 | 이름, 소속, 직업 또는 직책, 국적, 이메일 주소, 결제 내역 | Festa.io 또는 Tito.io 이벤트 플랫폼 | 이벤트 플랫폼을 통해 참가 등록 완료 시 | 5년 |
...
| 비자 초청장 요청 등록 및 안내 | (필수) 이름, 이메일, 국적, 소속, 여권번호, 여권 만료일 (필요시 요청) 여권 발급지 | 행사 웹사이트 및 Google Form | 준비위원회에서 제공한 Google Form 양식 제출 시 | 행사 종료 후 즉시 파기 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 주식회사 페스타 | 경기도 성남시 분당구 성남대로 331번길 8, 19층 | 참가자가 Festa.io 에서 참가 등록 시 | help@festa.io | 이름, 소속, 직업 또는 직책, 국적, 이메일 주소, 결제 내역 | 참가자 등록 및 결제 관리 | 5년 |
...
| 수탁자 | 위치 | 위탁 일시 및 방법 | 연락처 | 위탁 항목 | 위탁 업무 내용 | 보유 및 이용기간 |
| --- | --- | --- | --- | --- | --- | --- |
| Google LLC | 미국 | 준비위원회가 제공한 Google Form 을 통해 양식 제출 시 | googlekrsupport@google.com | 이름, 이메일, 휴대전화 번호, 소속, 직업 또는 직책, 은행 계좌 등 지급수단 정보, 여권번호, 여권 만료일, 여권 발급지 | 발표자 모집, 비자 초청장 신청, 여행 경비 지원 신청 등 | 1년 |
| Team Tito Limited | 64 Dame Street, Dublin, Ireland D02 RT72 | 참가자가 Tito 에서 참가 등록 시 | support@tito.io | 이름, 소속, 직업 또는 직책, 국적, 이메일 주소, 결제 내역 | 참가자 등록 및 결제 관리 | 5년 |
...
## 제15조(개인정보 처리방침 변경)		
1. 이 개인정보처리방침은 2022년 10월 15부터 적용됩니다.		
