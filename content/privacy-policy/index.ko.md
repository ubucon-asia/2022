---
title: "개인정보 처리방침"
description: "2022년 11월 4일 부터 적용"
---
...
> 이 개인정보처리방침은 2022년 11월 4일 부터 적용됩니다.		
...
| --- | --- | --- | --- | --- | --- | --- |
| 엔에이치엔클라우드 주식회사 | 경기도 성남시 분당구 대왕판교로645번길 16, 4,7층(삼평동, NHN) | support@nhncloud.com | 이름, 소속, 직책(직업), 국적, 이메일 | 행사, 이벤트, 최신 소식 전달 등 마케팅 목적 | 2년 | 종이에 인쇄 된 것은 분쇄 또는 소각, 전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을 사용 |
| 네이버클라우드(주) | 경기도 성남시 분당구 분당내곡로 131 13~15층 | 김상인 (sangin.kim@navercorp.com) | 이름, 소속, 직책(직업), 국적, 이메일, 체크인 여부, 티켓 유형, 작년 행사 참가 여부, 행사 참석 경로 | 네이버 클라우드 플랫폼 ncloud.com 월간 뉴스레터 발송, 교육/웨비나/이벤트 소식 알림 | 2년 | 보유기간 만료 후 자동 파기 |
...
## 제15조(개인정보 처리방침 변경)		
1. 이 개인정보처리방침은 2022년 11월 4일 부터 적용됩니다.		
